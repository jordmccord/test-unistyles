    ...
    return (
      <VStack space="2xl">
        <VariantTitle title="Heading 1">
          <Heading size="h1">
            Inter - Bold (700), 32px Size / 40px Line height / 0px Letter
          </Heading>
        </VariantTitle>
        <VariantTitle title="Heading 2">
          <Heading size="h2">
            Inter - Bold (700), 28px Size / 32px Line height / 0px Letter
          </Heading>
        </VariantTitle>
        <VariantTitle title="Heading 3">
          <Heading size="h3">
            Inter - Bold (700), 24px Size / 32px Line height / 0px Letter
          </Heading>
        </VariantTitle>
        <VariantTitle title="Heading 4">
          <Heading size="h4">
            Inter - Bold (700), 18px Size / 24px Line height / 0px Letter
          </Heading>
        </VariantTitle>
        <VariantTitle title="Heading 5">
          <Heading size="h5">
            Inter - Bold (700), 16px Size / 20px Line height / 0px Letter
          </Heading>
        </VariantTitle>
